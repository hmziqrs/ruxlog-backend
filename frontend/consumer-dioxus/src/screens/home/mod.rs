        ...
        div { class: "min-h-screen bg-background text-foreground",
            ...
            div { class: "border-b border-border/60 backdrop-blur-xl",
                div { class: "container mx-auto px-4 py-8",
                    ...
                    p { class: "text-muted-foreground", "Discover stories, thinking, and expertise from writers on any topic." }
                }
            }
                        ...
                        div { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                            for post in &data.data {
                                a {
                                    ...
                                    div { class: "p-6",
                                        h2 { class: "text-xl font-semibold mb-2 group-hover:text-primary transition-colors", "{post.title}" }
                                        
                                        if let Some(excerpt) = &post.excerpt {
                                            p { class: "text-muted-foreground text-sm mb-4 line-clamp-3", "{excerpt}" }
                                        }
